    ...
    return (
        <>
            <div className="loginBackground">
                <img className='imageSpeechBubble' key='imageSpeechBubble' alt="" src={imagesArr[111]}/>
                {iArr.map((image, i) => {
                    if(i === 111){
                        return null
                    }
                        ...
                        return (
                            <img className={'image' + i} key={i} alt="" src={image}/>
                        )
                    }
                })}
            </div>
                ...
                <h1 className="socialeyesTitle">Socialeyes</h1>
                    {
                        ...
                        <div className="registgerContainer2"> 
                            <>
                                ...
                                <p>Already registered? <span className="signButton" onClick={() => setHideLogin(!hideLogin)}>Sign in!</span></p>
                            </>
                        </div>
                        :
                        <div className="loginContainer2"> 
                            <>
                                ...
                                <p>Don't have an account? <span className="signButton" onClick={() => setHideLogin(!hideLogin)}>Sign up!</span></p>
                            </>
                        </div>
                    }
            </div>
...
mutation login(
    ...
    login(
        ...
        id email username createdAt token firstname lastname picture
    }
}
`
